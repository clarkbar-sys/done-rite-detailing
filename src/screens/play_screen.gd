## The game: the same garage the title screen was showing off, with the
## camera parked instead of circling.
##
...
## player will eventually do here (walk up to the car, pick up a tool, start a
## job) lands in this file, and having it already means the first one touches
## nothing else.
##
